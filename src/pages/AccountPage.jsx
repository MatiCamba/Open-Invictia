import {  Autocomplete, Avatar, Box, Button, Dialog, DialogActions, DialogContent, TextField } from "@mui/material"
...
export const AccountPage = ({name, email, photoURL}) => {
  ...
  const handleFileChange = (e) => {
      ...
      if (!isValidType) return enqueueSnackbar("Solo puedes subir imágenes", { variant: "error" })
      if (!isValidSize) return enqueueSnackbar("El archivo es demasiado grande.", { variant: "error" })
  ...
  const handleUpdateImg = async () => {
    if(!selectedFile) return enqueueSnackbar("Debes seleccionar una imagen", { variant: "warning" })
    try {
  ...
  return (
    <Box sx={{
        ...
        <Box sx={{display: 'flex'}}>
          <Avatar sx={{width: '10rem', height: '10rem', marginLeft:'2.5rem'}} src={photoURL}/>
          <div className="editimg-container">
            <img src={editWhite} alt="edit" className="editimg-icon" onClick={()=> setOpenImg(true)}/>
          </div>
        </Box>
        <Dialog
          open={openImg}
        ...
        <Box sx={{display: 'flex', marginLeft: '0.2rem', marginTop: '1.5rem'}}>
            ...
            <img src={editIcon} alt="edit" className="edit-icon" onClick={()=> setOpen(true)}/>
        </Box>
        ...
        <Box sx={{display: 'flex', marginLeft: '0.2rem', marginTop: '1.5rem'}}>
            ...
            <img src={editIcon} alt="edit" className="edit-icon" onClick={()=> setOpen2(true)}/>
        </Box>
        ...
        <Box sx={{display: 'flex', marginLeft: '0.2rem', marginTop: '1.5rem'}}>
            ...
            <img src={editIcon} alt="edit" className="edit-icon" onClick={()=> setOpenAge(true)}/>
        </Box>
        ...
        { genderSelected ? (
          <Box sx={{display: 'flex', marginTop: '1.5rem'}}>
            ...
            <img src={editIcon} alt="edit" className="edit-icon" onClick={() => setGenderSelected(false)}/>
          </Box>
        ) : (
          <Box sx={{display: 'flex', marginLeft: '0.2rem', marginTop: '1.5rem'}}
            component="form"
          ...
          {categorySelected ? (
            <Box sx={{display: 'flex',  marginTop: '1.5rem'}}>
              ...
              <img src={editIcon} alt="edit" className="edit-icon" onClick={() => setCategorySelected(false)}/>
